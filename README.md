...
Contains code samples from Learn OpenGL and [https://learnopengl.com](https://learnopengl.com), used to set up the project with the right libraries, and as a template for this readme. 
